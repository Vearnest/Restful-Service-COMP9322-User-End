...
<%@ page import="au.edu.unsw.soacourse.util.*"%>
...
<title>Welcome to FoundIT</title>
...
<body>
	<form action="FoundITServlet" method="post">
		<center>
			<table>
				<tr>
					<td colspan="4"><h3>Input Your Cover Letter</h3></td>
				</tr>
			</table>
			<table style="height: 300px">
				<tr>
					<td width="35%"><input type="text" name="coverLetter"
			...
			<table>
				<tr align="center">
					...
					<button type="submit" name="action" value="sendApplication">Send Application</button>
