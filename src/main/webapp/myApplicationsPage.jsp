...
<html>
<%
ArrayList<ApplicationSearch> myApplications = (ArrayList<ApplicationSearch>) session.getAttribute("myApplications");
%>
<head>
	...
	<table align="center" style="text-align: center;" width="80%" border="0">
		<table align="center" style="text-align: center;" width="80%" border="0">
				...
				for (int i = 0; i < myApplications.size(); i++) {
					ApplicationSearch myApplication = myApplications.get(i);
					number = i + 1;
			%>
			<table align="center" style="text-align: center;" width="20%" border="0">
 			<tr>
				<td><%=number%></td>
				<td><a href="FoundITServlet?action=myApplicationDetail&applicationId=<%=myApplication.get_applicationID()%>"><%=myApplication.getJobTitle() + "@" + myApplication.getCompanyName()%></a></td>
			</tr>
			<tr>
				<td></td><td><%="Status: "%></td><td><%=myApplication.getApplicationStatus()%></td>
			</tr>
			</table>
			<%
				}
