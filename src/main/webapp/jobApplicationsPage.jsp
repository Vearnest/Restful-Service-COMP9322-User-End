...
<html>
<%
ArrayList<ApplicationSearch> jobApplications = (ArrayList<ApplicationSearch>) session.getAttribute("jobApplications");
%>
<head>
	...
	<table align="center" style="text-align: center;" width="80%" border="0">
		<table align="center" style="text-align: center;" width="80%" border="0">
			...
			<table align="center" style="text-align: center;" width="20%" border="0">
 			<tr>
				<td><%=number%></td>
				<td><a href="FoundITServlet?action=jobApplicationDetail&applicationId=<%=jobApplication.get_applicationID()%>"><%="Application ID " + jobApplication.get_applicationID() + ": " + jobApplication.getJobTitle()%></a></td>
			</tr>
			<tr>
				<td></td><td><%="Status: "%></td><td><%=jobApplication.getApplicationStatus()%></td>
			</tr>
			</table>
			<%
				}
